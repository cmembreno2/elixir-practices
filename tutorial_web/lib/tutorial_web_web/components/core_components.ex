defmodule TutorialWebWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TutorialWebWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TutorialWebWeb.Gettext, "errors", msg, opts)
    end
  end
